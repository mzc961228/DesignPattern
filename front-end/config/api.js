const ApiRootUrl = 'http://192.168.1.10:8080/api/';
...
module.exports = {
    ...
    CartList: ApiRootUrl + 'cart/index' + "/" + userInfo.id, //获取购物车的数据
    CartUpdate: ApiRootUrl + 'cart/update', // 更新购物车的商品
    CartDelete: ApiRootUrl + 'cart/delete', // 删除购物车的商品
    CartChecked: ApiRootUrl + 'cart/checked', // 选择或取消选择商品
    CartGoodsCount: ApiRootUrl + 'cart/goodsCount' + "/" + userInfo.id, // 获取购物车商品件数
    CartCheckout: ApiRootUrl + 'cart/checkout', // 下单前信息确认,未完成
    // 商品
    ...
    GetAddresses: ApiRootUrl + 'address/getAddresses' + "/" + userInfo.id,
    ...
    OrderCountInfo: ApiRootUrl + 'order/orderCount'+ "/" + userInfo.id, // 我的页面获取订单数状态
